...
define(['durandal/system', 'durandal/app', 'durandal/viewLocator'], function (system, app, viewLocator) {
  ...
  system.debug(true); //>>excludeEnd("build");

  app.title = 'University Website Design - Easy Tutorials';
  app.configurePlugins({
    router: true,
    dialog: true //  set up widget path
    //  widget:{
    //      kinds:['expander']
    //  },
  ...
  app.start().then(function () {
    ...
    viewLocator.useConvention(); //Show the app by setting the root view model for our application with a transition.
